...
public class RookChessComponent extends ChessComponent {
    ...
    private Image rookStore;
    private Image rookRed;
    private static ImageIcon iconW = new ImageIcon("chessStore/rook-white.jpg");
    private static ImageIcon iconB = new ImageIcon("chessStore/rook-black.jpg");
    private static Image ROOK_W = iconW.getImage();
    private static Image ROOK_B = iconB.getImage();
    ...
    private void initiateRookImage(ChessColor color) {
        try {
            ...
            if (color == ChessColor.WHITE) {
                ...
                rookStore = ROOK_WHITE;
                rookRed = ROOK_W;
            } else if (color == ChessColor.BLACK) {
                rookImage = ROOK_BLACK;
                rookStore = ROOK_BLACK;
                rookRed = ROOK_B;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public RookChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, ClickController listener, MouseEnter mouseEnter, int size, Chessboard chessboard) {
    ...
    public boolean canMoveTo(ChessComponent[][] chessComponents, ChessboardPoint destination) {
        ...
        return true;//以return ture为默认条件来写
    }
